...
using Travel.Core.Application.Exceptions;
using Travel.Core.Application.Interfaces;
using Travel.Core.Application.Interfaces.Shared;
using Travel.Infrastructure.Data.Enums;
using Travel.Infrastructure.Data.Identity.Models;

namespace Travel.Infrastructure.Identity.Services
{
