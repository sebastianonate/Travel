...
using Travel.Infrastructure.Identity.Services;
using Travel.Infrastructure.Shared.Services;
using Travel.Infrastructure.WebApi.Services;

namespace CodeHero.Api.Extensions
{
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void ConfigureSwagger(this IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "CodeHero.Api");
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            ...
            {
                c.IncludeXmlComments(string.Format(@"{0}Travel.Infrastructure.WebApi.xml", System.AppDomain.CurrentDomain.BaseDirectory));
